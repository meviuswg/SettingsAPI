...
namespace SettingsAPIData
{
    ...
    public class SettingsAuthorizationException : Exception
    {
        ...
        public SettingsAuthorizationException(AuthorizationScope scope, AuthorizationLevel level, string objectName, int identity) : this(scope, level, objectName, identity, "Access Denied")
        {
